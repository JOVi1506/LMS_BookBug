...
<?php
   ...
   {  
      header("location:http://localhost/trial470/LMS/admin/indexAX.php");
      exit;
   }
...
<body>
            ...
            <div class="col-lg-6 text-center text-lg-right">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="http://localhost/trial470/LMS/index2.php" class="nav-item nav-link">Home</a>
                        </div>
    ...
    <div class="container-fluid">
        <h2 class="text-center mt-2 mb-0">Admin Login</h2>
    </div>
    <div class="container">
    <div id="login" class="text-center">
        <form method="post" class="mx-auto">
          <fieldset class="clearfix">
          <h6 class="mt-2 mb-0">Admin ID</h6>
            <p><span class="fontawesome-user"></span><input type="text"  name="emp_id" value="" onBlur="if(this.value == '') this.value = 'Admin ID'" onFocus="if(this.value == 'Admin ID') this.value = ''" required></p> 
