                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="cp/front/3.jpg" alt="Image">   <!--change here -->
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="cp/back/3.jpg" alt="Image"> <!--change here -->
                        </div>
                    </div>
                ...
                <div class="bg-light p-30">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="tab-pane-1">
                            ...
                            <p>""""The Talisman"" by Stephen King and Peter Straub is a gripping fantasy novel following twelve-year-old Jack Sawyer
                                on a perilous quest. Jack journeys through parallel worlds, known as ""the Territories"" and ""the United States,"" to find a magical
                                talisman that can cure his mother's cancer. Along the way, he faces dark forces, including the villainous Morgan Sloat and the
                                terrifying Black Hotel. As Jack confronts his fears and discovers his inner strength, he learns the true power of 
