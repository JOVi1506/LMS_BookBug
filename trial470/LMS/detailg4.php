                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="cp/front/4.jpg" alt="Image">   <!--change here -->
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="cp/back/4.jpg" alt="Image"> <!--change here -->
                        </div>
                    </div>
                ...
                <div class="bg-light p-30">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="tab-pane-1">
                            ...
                            <p>""""The Alchemist"" by Paulo Coelho follows Santiago, a young shepherd, on a transformative journey to fulfill his dreams. Leaving Spain
                                in search of treasure, he encounters wise mentors and learns the language of omens. Santiago discovers that the true treasure lies 
                                within oneself, and his pursuit of worldly riches evolves into a quest for spiritual enlightenment. Through symbolism and allegory,
                                Coelho explores themes of destiny, personal legend, and the importance of following one's heart to find true fulfillment and purpose in life.""
                            </p>
