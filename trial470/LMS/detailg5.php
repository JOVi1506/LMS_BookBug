                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="cp/front/5.jpg" alt="Image">   <!--change here -->
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="cp/back/5.jpg" alt="Image"> <!--change here -->
                        </div>
                    </div>
                ...
                <div class="bg-light p-30">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="tab-pane-1">
                            ...
                            <p>""""Confess"" by Colleen Hoover revolves around Auburn Reed, who finds herself drawn into the world of artist Owen Gentry. Auburn,
                                grappling with her past and present, becomes entangled in Owen's secrets and confessions, displayed in his art gallery. 
                                Their connection deepens as they navigate love, loss, and redemption. As Auburn confronts difficult choices, she learns the power 
                                of forgiveness and the healing that comes from sharing one's truths. ""Confess"" is a poignant tale of love, art, and the complexities of human emotion.""
                            </p>
