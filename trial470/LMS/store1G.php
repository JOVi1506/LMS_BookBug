                ...
                <div class="row pb-4">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,linkg,price FROM book where idx = 1";
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,linkg,price FROM book where idx = 2";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,linkg,price FROM book where idx = 3";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,linkg,price FROM book where idx = 4";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,linkg,price FROM book where idx = 5";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,linkg,price FROM book where idx = 6";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,linkg,price FROM book where idx = 7";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,linkg,price FROM book where idx = 8";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,linkg,price FROM book where idx = 9";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,linkg,price FROM book where idx = 10";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,linkg,price FROM book where idx = 11";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,linkg,price FROM book where idx = 12";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-12">
                        <nav>
                            <ul class="pagination justify-content-center">
                                ...
                                <li class="page-item active"><a class="page-link" href="http://localhost/trial470/LMS/store1G.php">1</a></li>
                                ...
                                <li class="page-item"><a class="page-link" href="http://localhost/trial470/LMS/store2G.php">Next</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
