        ...
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="cp/front/1.jpg" alt="Image"> <!--change here -->
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="cp/back/1.jpg" alt="Image"> <!--change here -->
                        </div>
                    </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                ...
                <div class="form-group">
                                                ...
                                                <?php
                                                    require('db.php');
                                                    $sql = "select title FROM book WHERE idx = 1";
                    ...
                    <div class="form-group">
                                                ...
                                                <?php
                                                    require('db.php');
                                                    $sql = "select authors FROM book WHERE idx = 1";
                                                    $rs = mysqli_query($con, $sql);
                                                    while($row = mysqli_fetch_assoc($rs))
                                                    {
                                                        $authors = $row['authors'];
                    ...
                    <div class="form-group">
                                                ...
                                                <?php
                                                    require('db.php');
                                                    $sql = "select genre FROM book WHERE idx = 1";
                                                    $rs = mysqli_query($con, $sql);
                                                    while($row = mysqli_fetch_assoc($rs))
                                                    {
                                                        $genre = $row['genre'];
                    ...
                    <div class="form-group">
                                                ...
                                                <?php
                                                    require('db.php');
                                                    $sql = "select price FROM book WHERE idx = 1";
                                                    $rs = mysqli_query($con, $sql);
                                                    while($row = mysqli_fetch_assoc($rs))
                                                    {
                                                        $price = $row['price'];
                ...
                <div class="bg-light p-30">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="tab-pane-1">
                            ...
                            <p>'Becoming' by Michelle Obama is a poignant memoir chronicling her journey from a childhood
                                in Chicago to the White House. Divided into three sections, it delves into her formative 
                                years, her relationship with Barack Obama, and her tenure as First Lady. Through candid 
                                reflections, she shares the highs and lows of her life, showcasing resilience, determination, 
                                and hope. The book offers an intimate portrayal of Obama's identity, values, and experiences, 
                                inspiring readers with her honesty and grace. ""Becoming"" is not just a personal narrative; 
                                it's a testament to the power of perseverance and the pursuit of one's dreams."
                            </p>
                        </div>
                        <div class="tab-pane fade" id="tab-pane-2">
                            <h4 class="mb-3">Additional Information</h4>
                                        ...
                                        <form name="form" method="post">
                                                ...
                                                <?php
                                                    require('db.php');
                                                    $sql = "select ISBN FROM book WHERE idx = 1";
                                                    $rs = mysqli_query($con, $sql);
                                                    while($row = mysqli_fetch_assoc($rs))
                                                    {
                                                        $ISBN = $row['ISBN'];
