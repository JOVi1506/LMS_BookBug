        ...
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="cp/front/28.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="cp/back/28.jpg" alt="Image">
                        </div>
                    </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                ...
                <div class="form-group">
                                                ...
                                                <?php
                                                    require('db.php');
                                                    $sql = "select title FROM book WHERE idx = 28";
                    ...
                    <div class="form-group">
                                                ...
                                                <?php
                                                    require('db.php');
                                                    $sql = "select authors FROM book WHERE idx = 28";
                                                    $rs = mysqli_query($con, $sql);
                                                    while($row = mysqli_fetch_assoc($rs))
                                                    {
                                                        $authors = $row['authors'];
                    ...
                    <div class="form-group">
                                                ...
                                                <?php
                                                    require('db.php');
                                                    $sql = "select genre FROM book WHERE idx = 28";
                                                    $rs = mysqli_query($con, $sql);
                                                    while($row = mysqli_fetch_assoc($rs))
                                                    {
                                                        $genre = $row['genre'];
                    ...
                    <div class="form-group">
                                                ...
                                                <?php
                                                    require('db.php');
                                                    $sql = "select price FROM book WHERE idx = 28";
                                                    $rs = mysqli_query($con, $sql);
                                                    while($row = mysqli_fetch_assoc($rs))
                                                    {
                                                        $price = $row['price'];
                ...
                <div class="bg-light p-30">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="tab-pane-1">
                            ...
                            <p>"The Alchemist" by Paulo Coelho follows Santiago, a young shepherd, on a transformative
                                journey to fulfill his dreams. Leaving Spain in search of treasure, he encounters wise 
                                mentors and learns the language of omens. Santiago discovers that the true treasure lies 
                                within oneself, and his pursuit of worldly riches evolves into a quest for spiritual 
                                enlightenment. Through symbolism and allegory, Coelho explores themes of destiny, personal 
                                legend, and the importance of following one's heart to find true fulfillment and purpose in life.
                            </p>
                        </div>
                        <div class="tab-pane fade" id="tab-pane-2">
                            <h4 class="mb-3">Additional Information</h4>
                                        ...
                                        <form name="form" method="post">
                                                ...
                                                <?php
                                                    require('db.php');
                                                    $sql = "select ISBN FROM book WHERE idx = 28";
                                                    $rs = mysqli_query($con, $sql);
                                                    while($row = mysqli_fetch_assoc($rs))
                                                    {
                                                        $ISBN = $row['ISBN'];
