        ...
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="cp/front/33.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="cp/back/33.jpg" alt="Image">
                        </div>
                    </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                ...
                <div class="form-group">
                                                ...
                                                <?php
                                                    require('db.php');
                                                    $sql = "select title FROM book WHERE idx = 33";
                    ...
                    <div class="form-group">
                                                ...
                                                <?php
                                                    require('db.php');
                                                    $sql = "select authors FROM book WHERE idx = 33";
                                                    $rs = mysqli_query($con, $sql);
                                                    while($row = mysqli_fetch_assoc($rs))
                                                    {
                                                        $authors = $row['authors'];
                    ...
                    <div class="form-group">
                                                ...
                                                <?php
                                                    require('db.php');
                                                    $sql = "select genre FROM book WHERE idx = 33";
                                                    $rs = mysqli_query($con, $sql);
                                                    while($row = mysqli_fetch_assoc($rs))
                                                    {
                                                        $genre = $row['genre'];
                    ...
                    <div class="form-group">
                                                ...
                                                <?php
                                                    require('db.php');
                                                    $sql = "select price FROM book WHERE idx = 33";
                                                    $rs = mysqli_query($con, $sql);
                                                    while($row = mysqli_fetch_assoc($rs))
                                                    {
                                                        $price = $row['price'];
                        ...
                        <div class="tab-pane fade" id="tab-pane-2">
                            <h4 class="mb-3">Additional Information</h4>
                                        ...
                                        <form name="form" method="post">
                                                ...
                                                <?php
                                                    require('db.php');
                                                    $sql = "select ISBN FROM book WHERE idx = 33";
                                                    $rs = mysqli_query($con, $sql);
                                                    while($row = mysqli_fetch_assoc($rs))
                                                    {
                                                        $ISBN = $row['ISBN'];
