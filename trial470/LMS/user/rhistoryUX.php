...
<script>
	...
	<div class="table-container">			 
        ...
        <?php
            include ('db.php');
            $sql="select inv_no, ISBN, prod_name, rent_date, return_due, return_date, penalty from rent_history where cus_id = '".$_SESSION['user']."' && return_date!='0000-00-00' && rent_date!='0000-00-00'";
