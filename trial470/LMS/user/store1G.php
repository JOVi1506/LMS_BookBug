                ...
                <div class="row pb-4">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="cp/front/1.jpg" alt="">
                            </div>
                            <div class="text-center py-4">
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,link,price FROM book where idx = 1";
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,link,price FROM book where idx = 2";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="cp/front/3.jpg" alt="">
                            </div>
                            <div class="text-center py-4">
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,link,price FROM book where idx = 3";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="cp/front/4.jpg" alt="">
                            </div>
                            <div class="text-center py-4">
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,link,price FROM book where idx = 4";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="cp/front/5.jpg" alt="">
                            </div>
                            <div class="text-center py-4">
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,link,price FROM book where idx = 5";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="cp/front/6.png" alt="">
                            </div>
                            <div class="text-center py-4">
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,link,price FROM book where idx = 6";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="cp/front/7.jpg" alt="">
                            </div>
                            <div class="text-center py-4">
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,link,price FROM book where idx = 7";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="cp/front/8.jpg" alt="">
                            </div>
                            <div class="text-center py-4">
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,link,price FROM book where idx = 8";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="cp/front/9.jpg" alt="">
                            </div>
                            <div class="text-center py-4">
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,link,price FROM book where idx = 9";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="cp/front/10.jpg" alt="">
                            </div>
                            <div class="text-center py-4">
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,link,price FROM book where idx = 10";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="cp/front/11.jpg" alt="">
                            </div>
                            <div class="text-center py-4">
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,link,price FROM book where idx = 11";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="cp/front/12.jpg" alt="">
                            </div>
                            <div class="text-center py-4">
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,link,price FROM book where idx = 12";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-12">
                        <nav>
                            <ul class="pagination justify-content-center">
                                ...
                                <li class="page-item active"><a class="page-link" href="http://localhost/trial470/LMS/user/store1G.php">1</a></li>
                                <li class="page-item"><a class="page-link" href="http://localhost/trial470/LMS/user/store2G.php">2</a></li>
                                <li class="page-item"><a class="page-link" href="http://localhost/trial470/LMS/user/store3G.php">3</a></li>
                                <li class="page-item"><a class="page-link" href="http://localhost/trial470/LMS/user/store2G.php">Next</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
