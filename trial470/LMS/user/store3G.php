                ...
                <div class="row pb-4">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,link,price FROM book where idx = 25";
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,link,price FROM book where idx = 26";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,link,price FROM book where idx = 27";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,link,price FROM book where idx = 28";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,link,price FROM book where idx = 29";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,link,price FROM book where idx = 30";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,link,price FROM book where idx = 31";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,link,price FROM book where idx = 32";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,link,price FROM book where idx = 33";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,link,price FROM book where idx = 34";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="form-group">
                                <?php
                                $sql2 = "SELECT title,link,price FROM book where idx = 35";
                                $rs = mysqli_query($con, $sql2);
                                while($row = mysqli_fetch_assoc($rs))
                                {
                                    $title = $row['title'];
